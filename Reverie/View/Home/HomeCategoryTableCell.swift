...
protocol HomeCategoryTableCellDelegate: AnyObject {
...
class HomeCategoryTableCell: UIPagingCollectionView {
    // MARK: - Properties
    ...
    weak var delegate: HomeCategoryTableCellDelegate?
    ...
    private lazy var viewAllLabel = UIButton().then {
        ...
        $0.titleLabel?.font = .panton(size: 16, bold: .semibold)
...
extension HomeCategoryTableCell {
